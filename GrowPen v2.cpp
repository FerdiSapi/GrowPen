		...
		++currentPeer)
	{
		...
		if (isHere(peer, currentPeer))
		{
			...
			if (val == 1 || val == 3 || val == 5 || val == 7 || val == 9 || val == 12 || val == 14 || val == 16 || val == 18 || val == 19 || val == 21 || val == 23 || val == 25 || val == 27 || val == 30 || val == 32 || val == 34 || val == 36) {
				if (((PlayerInfo*)(peer->data))->rawName == "xcoldv") {
...
#endif
{
	cout << "[!] GrowPen Server (C) xcoldv & iSteven & GrowtopiaNoobs" << endl;
	cout << "[!] GrowPen is Running" << endl;
...
#pragma warning(disable: 4996)
						...
						if (btn == "clearworld") {
							if (((PlayerInfo*)(peer->data))->gem > 5000) {
								...
								if (((PlayerInfo*)(peer->data))->currentWorld != "EXIT") {
									...
									Player::OnConsoleMessage(peer, "`oUsed `4GrowPen's `2Fast-Realtime-Clear system`w (like real gt)!``");
								}
							}
							else {
						...
						if (btn == "buyvip")
						{
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|\nadd_label_with_ele_icon|big|`wPurchase VIP``|left|9488|\nadd_smalltext|`oCurrently you have `9" + to_string(((PlayerInfo*)(peer->data))->wls) + " `oGrowPen Token````|left|\nadd_smalltext|`4Make sure to read this information clearly!``|left|\n\nadd_spacer|small|\nadd_textbox|Price: `32 Growtopia Diamond Locks.`4/`3200 GrowPen Token|left|\nadd_textbox|Duration: `w[`4~`w]|left|\nadd_textbox|Stock: `w[`4~`w]|\nadd_spacer|small|\nadd_textbox|`9Rules:|left|\nadd_smalltext|`91. `2Do Not Abuse Your Role|left|\nadd_smalltext|`94. `2Trying to sell account will result in ip-banned.|left|\nadd_spacer|small|\nadd_textbox|`9Commands:|small|\nadd_smalltext|`eAll commands are displayed in /vhelp (vip help).|small|\nadd_spacer|left|\nadd_textbox|`eHow To Buy:|\nadd_smalltext|`rIn Original growtopia, go to world `9'GrowPenDepo' `rAnd put your dls/wls there.|left|\nadd_spacer|small|\nadd_textbox|`eWhen will i received my purchase:|\nadd_smalltext|`rYou Will received within `424`r hours after you have made your payment.|left|\nadd_button|purchasevip|`wPurchase `cVIP `wUsing `6GrowPen Token|noflags|0|0|\nend_dialog|gazette|Close||"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "purchasemod")
						{
							...
							if (pinfo->wls >= 500) {
								...
								sendConsoleMsg(peer, "You need to have enough `6GrowPen Token `oTo purchase `#Moderator`o!");
							}
						}
						if (btn == "purchasevip")
						{
							...
							if (pinfo->wls >= 200) {
								...
								sendConsoleMsg(peer, "You need to have enough `6GrowPen Token `oTo purchase `cVIP`o!");
							}
						}
						if (btn == "infobutton") {
								...
								++currentPeerpx)
							{
								...
								if (((PlayerInfo*)(currentPeerpx->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) // if last wrench
								{
									if (((PlayerInfo*)(currentPeerpx->data))->rawName == "xcoldv") // if last wrench
									{
									...
									else if (((PlayerInfo*)(currentPeerpx->data))->rawName == "isteven") // if last wrench
									{
						...
						if (btn == "ipban") {
								...
								++currentPeer)
							{
								...
								if (isHere(peer, currentPeer))
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
										if (((PlayerInfo*)(currentPeer->data))->rawName == "xcoldv") continue;
										if (((PlayerInfo*)(currentPeer->data))->rawName == "isteven") continue;
										if (((PlayerInfo*)(currentPeer->data))->rawName == "isteven") continue;
											...
											++currentPeer)
										{
											...
											if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
												...
												GamePacket ps2 = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "`0Warning from `4System`0: You've been `4IP-BANNED  `0from GrowPen for 730 days"), "audio/hub_open.wav"), 0));
												ENetPacket * packet2 = enet_packet_create(ps2.data,
													ps2.len,
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(currentPeer, 0, packet2);
												GamePacket ps3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2+`w] `oWarning from `4System`o: You've been `4IP-BANNED `ofrom GrowPen for 730 days"));
						...
						if (btn == "suspend")
						{
								...
								++currentPeerp)
							{
								if (currentPeerp->state != ENET_PEER_STATE_CONNECTED)
									continue;
								if (((PlayerInfo*)(currentPeerp->data))->rawName == "xcoldv") continue;
						...
						if (btn == "disconnect")
						{
							if (getAdminLevel(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass) == 1200 || getAdminLevel(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass) == 1337)
							{
									...
									++currentPeerp)
								{
									if (currentPeerp->state != ENET_PEER_STATE_CONNECTED)
										continue;
									if (((PlayerInfo*)(peer->data))->lastInfo == "xcoldv") continue;
									if (((PlayerInfo*)(peer->data))->lastInfo == ((PlayerInfo*)(currentPeerp->data))->rawName)
									{
						...
						if (btn == "purchasegems")
						{
							GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "add_ele_label_with_icon|big|`wPurchase Gems using `9GrowPen Token|left|1430|\nadd_spacer|small|\nadd_textbox|`wPlease enter the `2Level Amount|left|\nadd_spacer|small|\nadd_textbox|`wAmount :|\nadd_text_input|leveloffer|||10|\nend_dialog|leveloffer|Cancel|Purchase!|\n"));
							ENetPacket* packet2 = enet_packet_create(p2.data,
								p2.len,
								ENET_PACKET_FLAG_RELIABLE);
						...
						if (btn == "purchaselvl")
						{
							GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "add_ele_label_with_icon|big|`wPurchase level using `9GrowPen Token|left|1430|\nadd_spacer|small|\nadd_textbox|`wPlease enter the `2Gems Amount|left|\nadd_spacer|small|\nadd_textbox|`wAmount :|\nadd_text_input|gemsoffer|||10|\nend_dialog|gemsoffer|Cancel|Purchase!|\n"));
							ENetPacket* packet2 = enet_packet_create(p2.data,
								p2.len,
								ENET_PACKET_FLAG_RELIABLE);
						...
						if (isFindDialog && btn.substr(0, 4) == "tool") {
							...
							if (id == 9492 || id == 9494) {
								if (((PlayerInfo*)(peer->data))->rawName == "xcoldv" || ((PlayerInfo*)(peer->data))->rawName == "isteven") {
								}
								else {
									sendConsoleMsg(peer, "`oThis item is for server-creator only!");
									break;
					...
					if (cch.find("text|") != std::string::npos) {
						...
						else if (str == "/save")
						{
							...
							if (adminlevel(((PlayerInfo*)(peer->data))->rawName) < 444) break;
							if (str.substr(6, cch.length() - 6 - 1) == "xcoldv") continue;
							if (str.substr(6, cch.length() - 6 - 1) == "isteven") continue;
							if (str.substr(6, cch.length() - 6 - 1) == "isteven") continue;
							...
							if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == PlayerDB::getProperName(pm_user)) {
										...
										enet_peer_send(peer, 0, packet0);
										delete p0.data;
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2+`w] `oYou Received `2" + pm_message + " `oGrowPen Token from `2" + ((PlayerInfo*)(peer->data))->displayName + "`4!"));
										string text = "action|play_sfx\nfile|audio/piano_nice.wav\ndelayMS|0\n";
										BYTE* data = new BYTE[5 + text.length()];
										BYTE zero = 0;
										int type = 3;
						...
						delete p.data;
							...
							if (((PlayerInfo*)(peer->data))->rawName == "xcoldv" || ((PlayerInfo*)(peer->data))->rawName == "isteven" || ((PlayerInfo*)(peer->data))->rawName == "isteven" || ((PlayerInfo*)(peer->data))->rawName == "isteven") {
						...
						if (imie == hasil) {
								...
								++currentPeer)
							{
								if (currentPeer->state != ENET_PEER_STATE_CONNECTED)
									continue;
								sendConsole(currentPeer, "`w** `eGrowPen Private Server `1Daily Math: (party) Math Event Winner is `w" + nama + "`9!");
						...
						if (((PlayerInfo*)(peer->data))->adminLevel > 333) {
							if ((str.substr(8, cch.length() - 8 - 1) == "xcoldv") || (str.substr(8, cch.length() - 8 - 1) == "isteven")) continue;
							if ((str.substr(8, cch.length() - 8 - 1) == "isteven") || (str.substr(8, cch.length() - 8 - 1) == "isteven")) continue;
							string name = str.substr(8, str.length());
						...
						{
							if (((PlayerInfo*)(peer->data))->adminLevel >= 444) {
								if ((str.substr(9, cch.length() - 9 - 1) == "xcoldv") || (str.substr(9, cch.length() - 9 - 1) == "isteven")) continue;
								if ((str.substr(9, cch.length() - 9 - 1) == "isteven") || (str.substr(9, cch.length() - 9 - 1) == "isteven")) continue;
								ENetPeer* currentPeer;
								string real = "";
					...
					if (!((PlayerInfo*)(event.peer->data))->isIn)
					{
						...
						if (!((PlayerInfo*)(event.peer->data))->haveGrowId)
						{
							...
							if (logStatus == -4) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2+`w] `4Your account have been locked for security reasons, If you believe its an mistake please contact `2Server Creator`4!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (logStatus == -3) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2+`w] `4Sorry, this account (`5" + ((PlayerInfo*)(event.peer->data))->rawName + "`4) has been suspended.If you have a question contact `2Server Creator`4!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								enet_peer_send(peer, 0, packet5);
								delete p5.data;
								sendConsoleMsg(peer, "`w[`2+`w] `1Connecting... `w[`cGrowPenPS `b- `2GrowtopiaNoobs`w]");
